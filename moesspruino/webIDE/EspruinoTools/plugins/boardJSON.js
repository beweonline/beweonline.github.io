...
(function(){
  ...
  function init() {
    Espruino.Core.Config.add("BOARD_JSON_URL", {
      ...
      type : "string",
      defaultValue : (Espruino.Core.Utils.needsHTTPS()?"https":"http")+"://beweonline.github.io/moesspruino/webIDE/json"
    });
  ...
  function loadJSON(env, jsonPath, callback) {    
	if(jsonPath == "http://beweonline.github.io/moesspruino/webIDE/json/ESP8266_4MB.json"){
		jsonPath = "moesspruino/webIDE/boardJSON/ESP8266_4MB.json";
	}
